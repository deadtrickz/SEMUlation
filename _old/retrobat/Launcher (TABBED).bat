...
if "%choice%"=="2" wt -w 0 nt -d %CD% powershell.exe -executionpolicy unrestricted ".\scripts\02_Remote_Media_Copy_slow_hdd.ps1"
if "%choice%"=="3" wt -w 0 nt -d %CD% powershell.exe -executionpolicy unrestricted ".\scripts\03_Remote_Media_Copy_fast_network.ps1"
