...
echo %ESC%[92m1: Find Missing EmulatinStation Videos%ESC%[0m
echo %ESC%[92m2: Match Media To Rom Names, Copy To Destination Folder - LOOSE%ESC%[0m
...
:: Handle choices
if "%choice%"=="1" wt -w 0 nt -d %CD% powershell.exe -executionpolicy unrestricted ".\scripts\01_EmulationStation_Find_Missing_VIdeos_With_Rom_Names.ps1"
if "%choice%"=="2" wt -w 0 nt -d %CD% powershell.exe -executionpolicy unrestricted ".\scripts\02_Generic_Match_Media_With_Rom_Name-LOOSE.ps1"
