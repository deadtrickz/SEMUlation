...
:: Handle choices
if "%choice%"=="1" start powershell.exe -executionpolicy unrestricted ".\scripts\Copy_Remote_Rom_Videos_to_Local_Folder-LOOSE.ps1"
if "%choice%"=="2" start powershell.exe -executionpolicy unrestricted ".\scripts\Copy_Remote_Rom_Videos_to_Local_Folder-STRICT.ps1"
if "%choice%"=="3" start powershell.exe -executionpolicy unrestricted ".\scripts\Diff-Files2Files.ps1"
if "%choice%"=="4" start powershell.exe -executionpolicy unrestricted ".\scripts\Diff-Folders2Files.ps1"
if "%choice%"=="5" start powershell.exe -executionpolicy unrestricted ".\scripts\ES_Find_ALL-MissingVideos.ps1"
if "%choice%"=="6" start powershell.exe -executionpolicy unrestricted ".\scripts\Find_DuplicateNames.ps1"
if "%choice%"=="7" start powershell.exe -executionpolicy unrestricted ".\scripts\Find_DuplicateSizes.ps1"
if "%choice%"=="8" start powershell.exe -executionpolicy unrestricted ".\scripts\Launchbox-RenameMedia2Filename-NO-FOLDER-LIMITATIONS.ps1"
if "%choice%"=="9" start powershell.exe -executionpolicy unrestricted ".\Launchbox-RenameMedia2Filename.ps1"
if "%choice%"=="10" start powershell.exe -executionpolicy unrestricted ".\scripts\LB-Copy_Remote_Rom_Videos_to_Local_Folder-LOOSE.ps1"
if "%choice%"=="11" start powershell.exe -executionpolicy unrestricted ".\scripts\LB-Rename_Media2Filename-FlattenChildFolderFiles.ps1"
if "%choice%"=="12" start powershell.exe -executionpolicy unrestricted ".\scripts\LB-Rename_Media2Filename.ps1"
if "%choice%"=="13" start powershell.exe -executionpolicy unrestricted ".\scripts\LB-Verify_or_Create_Rom_Folders.ps1"
if "%choice%"=="14" start powershell.exe -executionpolicy unrestricted ".\scripts\Verify_or_Create_BiosImagesVideos_Folders.ps1"
